...
public class AcsClientSingleton {
    ...
    private void init(){
        ...
        //替换成你的AK
        final String accessKeyId = ConfigUtil.getConfig(BaseConstant.CONFIG_TYPE_RUNTIME, "ALIYUN_SMS_AK").getConfigValue();//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = ConfigUtil.getConfig(BaseConstant.CONFIG_TYPE_RUNTIME, "ALIYUN_SMS_KS").getConfigValue();//你的accessKeySecret，参考本文档步骤2
