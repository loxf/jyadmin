...
!(function (document, undefined) {
    if ("undefined" == typeof SOTool) var SOTool = {}, SOTool = {
        PluginStack: {}, JsList: {}, shareObj: function (a, b) {
            ...
            if (videoSdkTool.isArray(a)) for (var d = 0; d < a.length; d++) arguments.callee(a[d], b); else if (a.hasOwnProperty("name") &&
    ...
    var DomainTool = function () {
        ...
        function b(a, b) {
            ...
            if (window && "https:" == window.location.protocol || "undefined" != typeof b && b) {
                if (-1 != a.indexOf("http://")) return d = a.split("://")[1], c.hasOwnProperty(d) && (d = c[d]), "https://" + d;
        ...
        return {
            getDomain: function (c, d, f) {
                var h = c;
                -1 != c.indexOf("://") && (h = c.match(/^http(|s):\/\/[a-zA-Z\.0-9:]*/)[0], h = c.replace(h, b(a(h, d), f)));
                return h
            }
        }
    }();
    ...
    var Message = function () {
        return {NoSupportPano: 0, Drm: 1, NoStart: 2, INTERRUPT: 3, END: 4, GSLB_IO: 470, Other: "other"}
    }();
    SOTool.shareObj("model.Message", Message);
    var LangTool = function () {
        var a = !1, b;
        return {
            loadLang: a, toMessage: function (d, c, g) {
                if (a) return b.hasOwnProperty(g) ? {message: b[g]} : {message: g};
                ...
                if (a) return b.hasOwnProperty(g.message) ? {message: b[g.message]} : "490" == g.code ? {message: g.message} : {message: b[Message.Other]};
                SOTool.getPlugin("lang.message.plugin." + c, function (c) {
                    c && (b = c, a = !0);
                    d()
                });
    ...
    var videoSdkTool = function () {
        ...
        var d = navigator.userAgent.toLowerCase(),
            c = {br: "", device: "", ver: "", params: null, os: ""};
        return {
            br: c, getOs: function () {
                "" == c.os && (c.os = b(d));
                return c.os
                ...
                if (null == c.params) {
                    var b = window.location.search, d = {};
                ...
                if ("" == c.ver) {
                    var b = {}, e;
                    (e = d.match(/msie ([\d.]+)/)) ?
                        b.msie = e[1] : (e = d.match(/firefox\/([\d.]+)/)) ? b.firefox = e[1] : (e = d.match(/360browser/)) ? b.b360 = e[1] ? e[1] : "-" : (e = d.match(/qqbrowser\/([\d.]+)/)) ? b.bqq = e[1] : (e = d.match(/ucbrowser\/([\d.]+)/)) ? b.buc = e[1] : (e = d.match(/baidubrowser\/([\d.]+)/)) ? b.bbaidu = e[1] : (e = d.match(/sogoumobilebrowser\/([\d.]+)/)) ? b.bsgm = e[1] : (e = d.match(/liebaofast\/([\d.]+)/)) ? b.blbfast = e[1] : (e = d.match(/mb2345browser\/([\d.]+)/)) ? b.b2345 = e[1] : (e = d.match(/4g explorer\/([\d.]+)/)) ? b.b4g = e[1] : (e = d.match(/huohoubrowser\/([\d.]+)/)) ? b.bhuohou =
                            e[1] : (e = d.match(/maxthon[\/ ]([\d.]+)/)) ? b.maxthon = e[1] : (e = d.match(/(opera)|(opr)\/([\d.]+)/)) ? b.opera = e[3] : (e = d.match(/chrome\/([\d.]+)/)) ? b.chrome = e[1] : (e = d.match(/version\/([\d.]+).*safari/)) ? b.safari = e[1] : b.other = "-";
                    e = "";
                    for (var f in b) e = b[f];
                    c.ver = e
                }
                return c.br + c.ver
                ...
                if ("undefined" != typeof a) {
                    var m = document.head || document.getElementsByTagName("head")[0] || document.documentElement,
                        n = document.createElement("script"), s;
                    n.type =
                        "text/javascript";
                    k && (n.charset = k);
                    n.onload = n.onreadystatechange = function () {
                        n.readyState && "loaded" != n.readyState && "complete" != n.readyState || (n = n.onreadystatechange = n.onload = n.onerror = null, clearTimeout(s), "function" == typeof b && b.call(d))
                    };
                    n.onerror = function () {
                ...
                var m = this.now(),
                    n = "letvcloud" + m + Math.floor(100 * Math.random()), s = "$1" + n + "$2", t = 0, q = 0, u = this,
                    r, v = -1,
                    w = document.head || document.getElementsByTagName("head")[0] || document.documentElement,
                    x = this.urlToObj(a);
                x.hasOwnProperty("callback") ? n = x.callback : (/_r=/i.test(a) || (a += "&callback=?"), a = a.replace(/(\=)\?(&|$)|\?\?/i, s));
                d = d || 5E3;
                var B = k || 2, C = l || 1E3;
                window[n] = function (a) {
                    z();
                    window[n] = null;
                    v = -1;
                    b.call(this, a, {responseTime: u.now() - m, retryCount: t})
                };
                var z = function () {
                    clearTimeout(q);
                    ...
                    z();
                    t >= B ? (clearTimeout(q), window[n] = null, c && c.call(this, null, {
                ...
                d = d || 5E3;
                var u = k || 2, r = l || 1E3, v = function () {
                    clearTimeout(0);
                    q && (q.onreadystatechange = null)
                }, w = function () {
                    v();
                    n >= u ? (clearTimeout(0), c && c.call(this, null, {
                    ...
                    q.onreadystatechange = function (a) {
                        4 == q.readyState && (200 == q.status ? (a = q.responseText, v(), t = -1, b.call(this, a, {
                                responseTime: s.now() - m,
                                retryCount: n
                            })) :
                            w())
                ...
                d = 16;
                for (c = 0; 32 > c; c++) b[c] = a[0 | Math.random() * d];
                return b.join("")
            }, urlToObj: function (a) {
                var b = {}, c = a;
                ...
                for (c = 0; c < a.length; c++) {
                    var d = a[c].substr(0, a[c].indexOf("=")), k = a[c].substr(a[c].indexOf("=") + 1);
                    b[d] = k
                }
                return b
                ...
                var b = "", c = 0,
                    d;
                for (d in a) b = 0 < c ? b + ("&" + d + "=" + a[d]) : b + (d + "=" + a[d]), c++;
                return b
                ...
                if ("undefined" != typeof b) {
                    ...
                    b =
                        null;
                    if (document.cookie && "" != document.cookie) for (c = document.cookie.split(";"), d = 0; d < c.length; d++) if (k = c[d], k.substring(0, a.length + 1) == a + "=") {
                ...
                if (window.localStorage) try {
                    if (localStorage.getItem(a)) return localStorage.getItem(a)
                } catch (c) {
                }
                return b ?
                    this.cookie(a) : -1
                ...
                if (a instanceof
                    Array) for (b = [], c = 0, d = a.length; c < d; c++) b[c] = "object" == typeof a[c] && null != a[c] ? arguments.callee(a[c]) : a[c]; else for (c in b = {}, a) b[c] = "object" == typeof a[c] && null != a[c] ? arguments.callee(a[c]) : a[c];
                return b
            }, isHttps: function () {
                try {
                ...
                a = a.split(b);
                var d = [];
                if ("undefined" == typeof c || c >= a.length) return a;
                for (; d.length < c - 1;) d.push(a[0]), a.shift();
                d[c - 1] = a.join(b);
                return d
            }
        }
        ...
        BaseCode =
            {
                decode: function (a) {
                    ...
                    if (!a) return a;
                    a += "";
                    do b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++)), d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++)), g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++)), e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++)), c = b << 18 | d << 12 | g << 6 | e, b = c >> 16 & 255, d = c >> 8 & 255, c &= 255,
                        64 == g ? k[h++] = String.fromCharCode(b) : 64 == e ? k[h++] = String.fromCharCode(b, d) : k[h++] = String.fromCharCode(b, d, c); while (f < a.length);
                    return g = k.join("")
                }, encode: function (a) {
                var b, d, c, g, e = 0, f = 0, h = "", h = [];
                if (!a) return a;
                a = this.utf8_encode(a + "");
                do b = a.charCodeAt(e++), d = a.charCodeAt(e++), c = a.charCodeAt(e++), g = b << 16 | d << 8 | c, b = g >> 18 & 63, d = g >> 12 & 63, c = g >> 6 & 63, g &= 63, h[f++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d) +
                    "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g); while (e < a.length);
                h = h.join("");
                switch (a.length % 3) {
                    case 1:
                        h = h.slice(0, -2) + "==";
                ...
                b = "";
                c = a.length;
                for (d = 0; d < c;) switch (g = a.charCodeAt(d++), g >> 4) {
                    case 0:
                    case 1:
                    case 2:
                    case 3:
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        e = a.charCodeAt(d++), f = a.charCodeAt(d++), b += String.fromCharCode((g & 15) << 12 | (e & 63) << 6 | (f & 63) << 0)
                }
                return b
            }
            }, MD5 = function () {
            ...
            return {
                hash: function (e) {
                    for (var f = [],
                             h = 0; h < 8 * e.length; h += 8) f[h >> 5] |= (e.charCodeAt(h / 8) & 255) << h % 32;
                    e = 8 * e.length;
                    f[e >> 5] |= 128 << e % 32;
                    f[(e + 64 >>> 9 << 4) + 14] = e;
                    e = 1732584193;
                    ...
                    f = [e, h, k, l];
                    e = "";
                    for (h = 0; h < 4 * f.length; h++) e += "0123456789abcdef".charAt(f[h >>
                    2] >> h % 4 * 8 + 4 & 15) + "0123456789abcdef".charAt(f[h >> 2] >> h % 4 * 8 & 15);
                    return e
                }
            }
        }(), UiTool = {
            getTemplate: function (a, b, d, c) {
                "undefined" != typeof d && (d = d.replace(/{#}/g, c), b = b.replace(/{#}/g, c), UiTool.loadCss(d));
                d = (new Date).getTime();
                ...
                a.innerHTML = b;
                for (e = 0; e < g.length; e++) f = g[e], a[f] = UiTool.$E(f + d);
                return g
            }, loadCss: function (a) {
                var b = document.head || document.getElementsByTagName("head")[0] ||
                    document.documentElement, d = document.createElement("style");
                ...
                if (a) {
                    var d = a.className;
                    0 == d.length ? a.className = b : d == b || d.match(new RegExp("(^|\\s)" +
                        b + "(\\s|$)")) || (a.className = d + " " + b)
                }
                ...
                } else a.attachEvent ? a.attachEvent("on" + b, d) : a.addEventListener(b, d, !1)
            }, removeEvent: function (a,
                                      b, d) {
                a = this.$E(a);
                if (null != a && "function" == typeof d && "undefined" != typeof b) if (-1 != b.indexOf(",")) {
                    b = b.split(",");
                    for (var c = 0, g = b.length; c < g; c++) {
                        var e = b[c];
                        if ("" == e) break;
                ...
                } else a.addEventListener ? a.removeEventListener(b, d, !1) : a.attachEvent && a.detachEvent("on" + b, d)
            }, getPos: function (a) {
                a = this.$E(a);
                ...
                var b = "createTouch" in document, d = y = 0, c = document.documentElement, g = document.body;
                a || (a = window.event);
                window.pageYOffset ? (d = window.pageXOffset, y = window.pageYOffset) : (d = (c && c.scrollLeft || g && g.scrollLeft || 0) - (c && c.clientLeft || g && g.clientLeft || 0), y = (c && c.scrollTop || g && g.scrollTop || 0) - (c && c.clientTop || g &&
                    g.clientTop || 0));
                b ? (a = a.touches.item(0), d = a.pageX, y = a.pageY) : (d += a.clientX, y += a.clientY);
                return {x: d, y: y}
                ...
                var d = "createTouch" in document,
                    c = UiTool.turnEvent("mousedown"), g = UiTool.turnEvent("mousemove"), e = UiTool.turnEvent("mouseup");
                ...
                a["on" + c] = function (c) {
                    ...
                    function l(c) {
                        c || (c = window.event);
                        d ? (c = c.touches.item(0), h = c.pageX - s, k = c.pageY - t) : (h = c.pageX ? c.pageX - s : c.clientX + document.body.scrollLeft - s, k = c.pageY ? c.pageY - t : c.clientY + document.body.scrollTop - t);
                        h = u.x + h;
                        k = u.x + k;
                        q && (h < q.x ? h = q.x : h > q.x + q.w && (h = q.x + q.w), k < q.y ? k = q.y : k > q.y + 0 + q.h &&
                            (k = q.y + q.h));
                        a.style.left = h + "px";
                        a.style.top = k + "px";
                    ...
                    d ? (c = c.touches.item(0),
                        s = c.pageX, t = c.pageY) : (s = c.clientX + n.body.scrollLeft, t = c.clientY + n.body.scrollTop);
                    var u = {x: parseInt(a.offsetLeft), y: parseInt(a.offsetTop)};
            ...
            getImgRealRect: function (a) {
                ...
                "undefined" != typeof a.naturalWidth && (b = a.naturalWidth, d = a.naturalHeight);
                return {width: b, height: d}
            }, isMobileEvent: function (a) {
                return -1 != ["touchstart", "touchmove", "touchend"].indexOf(a)
            }, hexToRgba: function (a, b) {
                var d = a.toLowerCase(), c = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/;
                if (d && c.test(d)) {
                    if (4 === d.length) {
                        for (var g = "#", c = 1; 4 > c; c += 1) g += d.slice(c, c + 1).concat(d.slice(c, c + 1));
                        d = g
                    }
                    g = [];
                    for (c = 1; 7 > c; c += 2) g.push(parseInt("0x" + d.slice(c, c + 2)));
                    return "RGBA(" +
                        g.join(",") + "," + b + ")"
                }
                return d
            }, setCanvasColor: function (a, b) {
                for (var d = a.getContext("2d"), c = d.getImageData(0, 0, a.width, a.height), g = 0; g < c.data.length; g += 4) if (0 != c.data[g + 3]) {
        ...
        return {
            log: function (d, c, g) {
                ...
                if (a != d) try {
                    ...
                    if (-1 != window.location.href.indexOf("#dSDK=1") || "file" == window.location.href.substr(0, 4).toLocaleLowerCase()) -1 != window.location.href.indexOf("#stack=1") && console.log(Error().stack), window.console && window.console.log(d, c, g, f);
    ...
    var ReportTool = function () {
        ...
        FlashPlayer = {
            isSupportFlash: !1, isEmdbed: !1, num: 0, check: function (a) {
                ...
                for (var b = b.split(/\s+/), g = 0, e = b.length; g < e; g++) parseInt(b[g]) > a && (this.isSupportFlash =
                    !0);
                ...
                if (this.check(g.version)) {
                    if (this.isEmdbed) for (e in d = ["<embed name='" + c + "'src='" + g.url + "' pluginspage='http://www.macromedia.com/go/getflashplayer' type='application/x-shockwave-flash' width='" +
                    g.width + "' height='" + g.height + "' ", " />"], b = "", g) "width" != e && "height" != e && "url" != e && (b += e + "='" + g[e] + "' "); else for (e in b = "", d = ["<object id='" + c + "' classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,45,0' type='application/x-shockwave-flash' width='" + g.width + "' height='" + g.height + "'><param name='movie' value='" + g.url + "'/>", "</object>"], g) "width" != e && "height" != e && "url" != e && (b += "<param name='" + e + "' value='" + g[e] +
                        "'/>");
                    b = d.join(b)
                } else b = '<div style="width:' + g.width + "px; height:" + g.height + 'px; text-align:center;"><span style="line-height:200%; font-size:18px">\u5b89\u88c5\u6216\u8005\u66f4\u65b0\u7248\u672c\u4e0d\u5c0f\u4e8e<b style="color:red">' + g.version + '</b>\u7684flash\u64ad\u653e\u5668, \u8bf7\u70b9\u51fb<a href="http://get.adobe.com/cn/flashplayer/" target="_blank">\u8fd9\u91cc</a>\u5b89\u88c5</span></div>';
            ...
            return {
                inherits: function (a, d) {
                    ...
                    try {
                        c.prototype = d.prototype, a.prototype = new c, a.prototype.constructor = a, a.prototype.superClass = d.prototype
                    } catch (g) {
                        debugger
                    }
                }, provideClass: function (a, d) {
                    var c = a.split(".");
                    if (1 < c.length) for (var g = 0; g < c.length - 1; g++) {
                        var e = c[g];
                    ...
                    for (var d = b.split("."), c = a, g = 0; g < d.length - 1; g++) {
                        var e = d[g];
                        if (!c.hasOwnProperty(e)) throw"the " +
            ...
            defList: "180 350 1000 1300 yuanhua 720p 1080p k4".split(" "), settingList: function () {
                ...
                switch (videoSdkTool.getDevice()) {
                    ...
                    case "android":
                        ...
                        for (var c = navigator.userAgent.toLowerCase(), b = 0; b < a.length; b++) if (-1 != c.indexOf(a[b].toLowerCase())) return "mp4";
                        if (/samsung/i.test(c) && /weibo/i.test(c)) break;
    ...
    SOTool.shareObj("manager.ColorManager", function () {
        ...
        a.prototype.setColor = function (a, c, g, e) {
            ...
            -1 == f ? (this.managerDsipayList.push(a), this.cList.push({
                display: a,
                key: c,
                type: g,
                alpha: e
            })) : (this.cList[f].key =
                c, this.cList[f].type = g, this.cList[f].alpha = e)
        };
        a.prototype.register = function (a) {
            for (var c in a) this.colorConfig.hasOwnProperty(c) && ("0x" == a[c].substr(0, 2) && (a[c] = a[c].substr(2)), "#" != a[c].substr(0, 1) ? this.colorConfig[c] = "#" + a[c] : this.colorConfig[c] = a[c])
        };
    ...
    var ClassObject = function () {
        ...
        a.prototype = {
            init: function () {
                ...
                if ("undefined" == typeof a) throw this.log(a), Error("type is undefined");
                if ("undefined" == typeof d) throw this.log(d), Error("handler is undefined");
                "undefined" == typeof c && (c = this);
                this.hasOwnProperty("EventMap") || (this.EventMap = {});
                this.EventMap.hasOwnProperty(a) || (this.EventMap[a] = []);
                this.hasEventListener(a, d, c) || this.EventMap[a].push({fun: d, target: c})
            }, hasEventListener: function (a, d,
                                           c) {
                if ("undefined" == typeof a) throw this.log(a), Error("type is undefined");
                if ("undefined" == typeof d) throw this.log(d), Error("handler is undefined");
                if ("undefined" == typeof c) throw this.log(c), Error("handlerThis is undefined");
                if (this.hasOwnProperty("EventMap") && this.EventMap.hasOwnProperty(a)) for (var g = 0; g < this.EventMap[a].length; g++) {
                    var e = this.EventMap[a][g];
                    if (e.fun == d && e.target == c) return !0
                }
                return !1
                ...
                if (this.EventMap.hasOwnProperty(d)) {
                    for (var c = [], g = 0; g < this.EventMap[d].length; g++) c.push(this.EventMap[d][g]);
                    for (g = 0; g < c.length; g++) c[g].fun.call(this.EventMap[d][g].target, a)
                }
            }, removeEventListener: function (a, d, c) {
                this.hasOwnProperty("EventMap") || (this.EventMap = {});
                if (this.EventMap.hasOwnProperty(a)) for (var g = 0; g < this.EventMap[a].length; g++) if (this.EventMap[a][g].fun == d && this.EventMap[a][g].target == c) {
    ...
    var Proxy = function () {
        ...
        a.prototype.initPlugin = function (a, d, c) {
            this.pluginCmpFun = d;
            this.REConf = c;
            if (this.REConf.hasOwnProperty(a.type)) if (d = this.REConf[a.type], d.hasOwnProperty("check")) if ("function" == typeof d.check) if (d.check()) this.load(a);
            else a.onerror(d.err); else if (d.check) this.load(a); else a.onerror(d.err); else this.load(a); else this.pluginCmpFun(null), a.onstart()
        };
        a.prototype.load = function (a) {
            var d = this;
            d.pl = this.REConf[a.type];
            SOTool.getPlugin(d.pl.name, function (c) {
                if (c) d.pluginCmpFun(c); else a.onerror({code: 420, message: "\u63d2\u4ef6\u52a0\u8f7d\u9519\u8bef"})
            })
        };
        return a
    }(), View = function () {
        ...
        a.prototype.setUp = function (a, d, c) {
            ...
            if (d) for (d = 0; d < a.length; d++) this.el[a[d]] = new DisplayObject(this.el[a[d]]);
    ...
    var DisplayObject = function () {
        ...
        var b = SOTool.getObj("common.ClassTool"), d = SOTool.getObj("core.ClassObject"),
        ...
        a.prototype.render = function (a) {
            if (this.el.hasAttribute("render-data")) {
                var b = videoSdkTool.split(this.el.getAttribute("render-data"), ";", 3), d = b[1], h = b[2];
                switch (b[0]) {
                    case "canvas":
                        if ("img" == d) if (this.renderCanvas) this.el.hasOwnProperty("renderOption") ?
                            this.el.renderOption = a : c.setCanvasColor(this.renderCanvas, a.color); else {
                            var b = videoSdkTool.split(h, ";", 3), k = document.createElement("img"),
        ...
        a.prototype.setColor = function (a, c) {
            "bg" == c ? this.el.hasAttribute("render-data") ?
                this.render({color: a}) : this.el.style.backgroundColor = a : "text" == c && (this.el.style.color = a)
        };
        ...
        a.prototype.removeAttribute = function (a) {
            if (videoSdkTool.isArray(a)) for (var c = 0; c < a.length; c++) this.el.removeAttribute(a[c]); else this.el.removeAttribute(a)
        };
    ...
    var AutoLoader = function () {
        ...
        a.prototype = {
            load: function (a, d, c, g) {
                this.urlList = a;
                var e = this, f = 0, h = videoSdkTool.now(), k = function () {
                    clearTimeout(e.delayID);
                    var a = e.getRealUrl(e.urlList[0]);
                    e.log("load url:" + a);
                    videoSdkTool.getJSON(a, function (a, c) {
                        f += c.retryCount;
                        d && d.call(g, a, {responseTime: videoSdkTool.now() - h, retryCount: f})
                    }, function (a, b) {
                        1 < e.urlList.length ? (f += e.urlList[0].maxCount, e.urlList.shift(), e.delayID = setTimeout(k, e.urlList[0].retryTime)) : (f += b.retryCount, c && c.call(g, null, {
                ...
                var e = this, f = 0, h = videoSdkTool.now(), k = function () {
                    ...
                    videoSdkTool.getJSONbyAjax(a, function (a, c) {
                        ...
                        1 < e.urlList.length ? (f += e.urlList[0].maxCount, e.urlList.shift(), e.delayID = setTimeout(k, e.urlList[0].retryTime)) :
                            (f += b.retryCount, c && c.call(g, null, {
        ...
        a.prototype = {
            start: function () {
                ...
                var d = this;
                clearTimeout(this.T);
                if (a && (d.currentCount++, d.timerHandler.call(d.handlerThis), 0 < d.max && d.currentCount >= d.max)) {
                    d.stop();
                    return
                }
        ...
        SkinTpl: "", setPlayerCss: function (a) {
            ...
            if ("" == SkinRender.SkinTpl) {
                ...
                for (var e in a) for (a[e] = a[e].replace(/{#}/g,
                    g), b = a[e].match(/{[a-z_A-Z0-9]{1,}\.[a-z_A-Z0-9]{1,}}/g) || [], d = 0; d < b.length; d++) {
                    var f = b[d].replace(/{|}/g, "").split("."), h = f[0], f = f[1];
                    c && c.hasOwnProperty(h) && c[h].hasOwnProperty(f) && (h = [h, c[h][f].width, c[h][f].height, c[h][f].src].join(";"), a[e] = a[e].replace(b[d], h))
                }
    ...
    var AdEvent = function () {
        return {EVENT: "adEvent", HEADSTART: "adHeadPlayStart", HEADEND: "adHeadPlayComplete", NOAD: "adHeadPlayNone"}
    }();
    ...
    var Model = function () {
        ...
        function g() {
            for (var a =
                "title duration volume definition defaultDefinition fullscreen percent time url videoWidth videoHeight".split(" "), c = this, b = 0; b < a.length; b++) this[a[b]] = "";
            ...
            init: function (a) {
                switch (this.platform) {
                    case "sdk":
                        ...
                        delete a.ptype;
                        for (var c = "autoplay uu vu liveId streamId activityId lang".split(" "), b =
                            0; b < c.length; b++) {
                            var d = c[b];
        ...
        a.prototype.load = function (a) {
            var d = this.model;
            d.playerConfig.refresh({mloadingUrl: "", logo: {pic: ""}});
            var c = {ark: 0, gslb: !1}, g = {350: {}};
            g["350"].vtype = "350";
            g["350"].definition = "\u539f\u753b";
        ...
        var b = MD5.hash("gpc_pet"), d = MD5.hash("gpc_playerInfo");
        ClassTool.inherits(a, Proxy);
        a.prototype.load = function (a) {
            this.curTime = 0;
        ...
        a.prototype.getRequestList = function () {
            ...
            a.push({
                url: f,
                timeout: 5E3, maxCount: 3, retryTime: 0
            });
            for (k = 0; k < d.length; k++) -1 != a[0].url.indexOf("//api.letvcloud.com/") && (e = f.replace("//api.letvcloud.com/", d[k]), a.push({
                url: e,
                timeout: 5E3,
                maxCount: 3,
                retryTime: 0
        ...
        a.prototype.getSpf = function () {
            var a = videoSdkTool.getDevice(), b = {androidPhone: 0, iphone: 1, letvTv: 2, ipad: 3, androidPad: 4};
        ...
        a.prototype.loadCmp = function (a, g) {
            if (!this.isClose) {
                ...
                if (0 == a.code) {
                    ...
                    f = {};
                    videoSdkTool.getLocal(b, !1) != a.playerinfo.pet && a.playerinfo.hasOwnProperty("logo") ? videoSdkTool.setLocal(d,
                        jsonTool.jsonToString(a.playerinfo), !1) : (f = jsonTool.stringToJson(videoSdkTool.getLocal(d)), a.playerinfo = f);
                    var h = {buttonColor: "fault", progressBarColor: "active"}, f = {};
                    ...
                    for (var k in a.playerinfo.onoff) h.hasOwnProperty(k) && (a.playerinfo.onoff[h[k]] = a.playerinfo.onoff[k],
                        delete a.playerinfo.onoff[k], k = h[k]), e.outConfig.hasOwnProperty(k) || (e.config.hasOwnProperty(k) ? "boolean" == typeof e.config[k] && (e.config[k] = "1" == a.playerinfo.onoff[k]) : e.config[k] = a.playerinfo.onoff[k]);
                    "zh_CN" != e.config.lang && (e.config.nskin = 7, e.config.share = !1);
                    f = {};
                    ...
                    for (var h = {}, l = 0; l < a.videoinfo.medialist.length; l++) {
                        ...
                        h[k].urls = [];
                        for (var n =
                            0; n < m.urllist.length; n++) h[k].urls.push(this.checkGslbUrl(BaseCode.decode(m.urllist[n].url)));
                    ...
                    [{code: ERR.VOD_MMSID_ANALY, message: a.message}, g]))
            }
        };
        a.prototype.reload = function () {
            this.unload();
        ...
        var b = MD5.hash("mms_pet"), d = MD5.hash("mms_playerInfo");
        ClassTool.inherits(a, Proxy);
        a.prototype.getRequestList = function () {
            ...
            a.push({
                url: videoSdkTool.bindFun(function (a) {
                    ...
                    for (c in h) "cf" != c && (b += "&" + c + "=" + encodeURIComponent(h[c]));
                    h.pageurl = window.location.href;
                    c = this.getSign(h);
                    b += "&sign=" + c + "&pageurl=" + encodeURIComponent(h.pageurl);
                    "undefined" != typeof a &&
                    (b = b.replace("//api.mms.lecloud.com/", a));
                    return b
                }, this), timeout: 5E3, maxCount: 3, retryTime: 0
            });
            for (k = 0; k < d.length; k++) a.push({url: a[0].url, timeout: 5E3, maxCount: 3, retryTime: 0, args: d[k]});
            return a
        };
        a.prototype.getSign = function (a) {
            var b = [], d;
            ...
            b.sort();
            d = "";
            for (var f = 0; f < b.length; f++) d += a[b[f]];
        ...
        a.prototype.loadCmp = function (a, g) {
            if (!this.isClose) {
                ...
                if (0 == a.code) {
                    ...
                    f.userId = a.userinfo.userid;
                    e.userData.refresh(f);
                    videoSdkTool.getLocal(b, !1) != a.playerinfo.pet && a.playerinfo.hasOwnProperty("logo") ? videoSdkTool.setLocal(d, jsonTool.jsonToString(a.playerinfo), !1) : (f = jsonTool.stringToJson(videoSdkTool.getLocal(d)), a.playerinfo = f);
                    f = {};
                    f.mloadingUrl = a.playerinfo.loadingpic;
                    f.logo = a.playerinfo.logo;
                    f.watermark = a.playerinfo.watermark;
                    e.playerConfig.refresh(f);
                    var f = {buttonColor: "fault", progressBarColor: "active"}, h;
                    for (h in a.playerinfo.onoff) f.hasOwnProperty(h) &&
                    (a.playerinfo.onoff[f[h]] = a.playerinfo.onoff[h], delete a.playerinfo.onoff[h], h = f[h]), e.outConfig.hasOwnProperty(h) || (e.config[h] = a.playerinfo.onoff[h]);
                    ...
                    f.defaultDefinition = a.videoinfo.medialist[0].vtype;
                    f.isdrm = a.videoinfo.isdrm;
                    if (a.videoinfo.hasOwnProperty("ark")) f.ark = a.videoinfo.ark; else if (a.videoinfo.hasOwnProperty("sspAd")) {
                        h =
                            {};
                        h.sspId = a.videoinfo.sspAd.sspMediaId;
                        if (a.videoinfo.sspAd.hasOwnProperty("slots")) for (var k = 0; k < a.videoinfo.sspAd.slots.length; k++) a.videoinfo.sspAd.slots[k].hasOwnProperty("rollType") && ("PRE" == a.videoinfo.sspAd.slots[k].rollType ? h.preSlotId = a.videoinfo.sspAd.slots[k].slotId : "PAUSE" == a.videoinfo.sspAd.slots[k].rollType && (h.pauseSlotId = a.videoinfo.sspAd.slots[k].slotId));
                        f.sspAd = h
                    }
                    f.mmsid = a.videoinfo.mmsid;
                    f.pano = a.videoinfo.pa;
                    ...
                    for (var l = {}, k = 0; k < a.videoinfo.medialist.length; k++) {
                        ...
                        l[h] = {};
                        l[h].urls = [];
                        for (var n = 0; n < m.urllist.length; n++) l[h].urls.push(m.urllist[n].url);
        ...
        a.prototype.loadError = function (a, b) {
            this.isClose ||
            this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{code: ERR.VOD_CONFIG_IO}, b]))
        };
        return a
    }(), GslbProxy = function () {
        function a(a) {
        ...
        ClassTool.inherits(a, Proxy);
        a.prototype.getRequestList = function () {
            var a = [], d = videoSdkTool.clone(this.model.videoSetting.urls);
            videoSdkTool.addUrlParams(d, {jsonp: "?", _r: "jsonp", format: 1, expect: 3});
            for (var c = 0; c < d.length; c++) {
                var g = this.checkGslbUrl(d[c]);
                a.push({url: g, timeout: 1E4, maxCount: 3, retryTime: 0})
            }
            return a
        };
        a.prototype.checkGslbUrl = function (a) {
            "ios" == this.model.vodPlayType &&
            -1 == a.indexOf("&tss=ios&") && (a = -1 != a.indexOf("&tss=no&") ? a.replace("&tss=no&", "&tss=ios&") : a + "&tss=ios");
            "mp4" == this.model.vodPlayType && -1 == a.indexOf("&tss=no&") && (a = -1 != a.indexOf("&tss=ios&") ? a.replace("&tss=ios&", "&tss=no&") : a + "&tss=no");
            return a
        };
        a.prototype.loadCmp = function (a, d) {
            if (!this.isClose) if (this.log("gslb data:" + jsonTool.jsonToString(a) + " time" + jsonTool.jsonToString(d)), 200 == a.status) {
                a.ercode = "0";
                for (var c = [a.location], g = 0; g < a.nodelist.length; g++) a.nodelist[g].location != c[0] && c.push(a.nodelist[g].location);
        ...
        var d = {
            ...
            sdk: {
                value: 32,
                sub: {value: 321, ios: {value: 321, domain: "https://apple-www.le.com"}, android: {value: 322}}
            },
            html5: {value: 31, sub: {value: 310, ios: {value: 311}, android: {value: 312}, pc: {value: 310}}},
            wx: {value: 31, sub: {value: 310, ios: {value: 311}, android: {value: 312}, pc: {value: 310}}}
        }, g = {android: 600, ios: 601};
        b.prototype = {
            init: function () {
                this.model.reportParam.p1 = 3;
                this.model.reportParam.p2 = c[this.model.platform.toLowerCase()].value;
                c[this.model.platform.toLowerCase()].sub.hasOwnProperty(this.model.systemData.os.toLowerCase()) ? (this.replaceDomain(c[this.model.platform.toLowerCase()].sub[this.model.systemData.os.toLowerCase()]), this.model.reportParam.p3 = c[this.model.platform.toLowerCase()].sub[this.model.systemData.os.toLowerCase()].value) : this.model.reportParam.p3 = c[this.model.platform.toLowerCase()].sub.value
            },
            replaceDomain: function (a) {
                if (a.hasOwnProperty("domain")) for (var b in d) "string" == typeof d[b] && ("http" === a.domain.substr(0, 4) ? d[b] = d[b].replace(/^http:\/\/apple.www.letv.com/g, a.domain) : d[b] = d[b].replace(/apple.www.letv.com/g, a.domain))
            }, reset: function () {
                ...
                switch (a) {
                    ...
                    case "bufferEmpty":
                        ...
                        break;
                    case "bufferFull":
                        "bufferEmpty" == this.reportParam.state && this.reportParam.isStartPlay &&
                        (this.resumePtStat(), this.sendPlayStat("eblock"));
                    ...
                    case "definition":
                        this.reportParam.isStartPlay &&
                        (this.pausePtStat(), this.model.videoSetting.definitionCount++, this.reportParam.replaytype = 2, this.sendPlayStat("tg"));
                        break;
                    case "stopPlay":
                ...
                this.heartTimer ? this.heartTimer.running || (this.setDelay(), this.heartTimer.start()) : (this.heartTimer = new Timer(d.heartTime, this, this.heartHanlder), this.setDelay(), this.heartTimer.start())
            },
            pauseHeadStat: function () {
                ...
                this.reportParam.isPauseRecord ||
                0 == this.reportParam.lastTime || (this.reportParam.pt += b - this.reportParam.lastTime);
                ...
                if ("html5" == this.model.platform || "wx" == this.model.platform) a += "&lc=" + this.checkValue(b.lc()), a += "&app_name=bcloud_h5";
                ...
                a += "&nt=" +
                    this.checkValue(b.systemData.nt, "none");
                ...
                var c = d.playUrl, k = this.model, c = c + ("?ver=" + this.checkValue(d.VERSION)),
                    ...
                    c = c + ("&ac=" + this.checkValue(a)), c = c + ("&prg=" + this.checkValue(k.videoInfo().time));
                "time" == a && (6E4 < this.reportParam.pt && (this.reportParam.pt = 6E4), 0 > this.reportParam.pt && (this.reportParam.pt = 0), c += "&pt=" + this.checkValue(Math.abs(Math.round(0.001 * this.reportParam.pt))));
                if ("html5" == this.model.platform || "wx" == this.model.platform) c += "&lc=" + this.checkValue(k.lc()), c += "&app_name=bcloud_h5";
                "sdk" == this.model.platform && (c += "&auid=" + this.checkValue(k.auid()), c += "&app_name=0");
                c += "&uuid=" + this.checkValue(k.uuid());
                "vod" == k.playType && (c += "&cid=" + this.checkValue(k.videoSetting.cid), "" != k.videoSetting.pid && (c += "&pid=" + this.checkValue(k.videoSetting.pid)), c += "&vid=" + this.checkValue(k.videoSetting.vid), c = c + "&ty=0" + ("&vlen=" + this.checkValue(k.videoSetting.duration)));
                "live" == k.playType && (c += "&lid=" + this.checkValue(k.videoSetting.lid), c += "&sid=" + this.checkValue(k.videoSetting.sid), c += "&ty=1", c += "&vlen=6000", k.videoSetting.hasOwnProperty("activityId") && (c += "&zid=" + this.checkValue(k.videoSetting.activityId)));
                c += "&ch=" +
                    this.checkValue(k.getTypeFrom());
                ...
                "init" == a && "sdk" == this.model.platform && (c += "&cdev=" + this.checkValue(k.systemData.cdev), c += "&caid=" + this.checkValue(g[k.systemData.os.toLowerCase()]));
                "play" == a && (c += "&pay=0", b && b.hasOwnProperty("cv") && (c += "&stc=" + encodeURIComponent(this.checkValue(videoSdkTool.objectParseToString(b.cv.stc))), c += "&joint=" + this.checkValue(b.cv.joint)));
                c += "&prl=0";
                ...
                "sdk" != this.model.platform && (c += "&url=" + encodeURIComponent(this.checkValue(window ? window.location.href : "")), c += "&ref=" + encodeURIComponent(this.checkValue(document ? document.referrer : "")));
            ...
            sendErrorStat: function (a) {
                var b = d.erUrl, c = this.model, b = b + ("?ver=" + this.checkValue(d.VERSION)),
                ...
                if ("html5" == this.model.platform || "wx" == this.model.platform) b += "&lc=" + this.checkValue(c.lc()), b += "&app_name=bcloud_h5";
                "sdk" == this.model.platform && (b += "&auid=" + this.checkValue(c.auid()), b += "&app_name=0");
                ...
                "vod" == c.playType && (b += "&cid=" + this.checkValue(c.videoSetting.cid), "" != c.videoSetting.pid && (b += "&pid=" + this.checkValue(c.videoSetting.pid)), b +=
                    "&vid=" + this.checkValue(c.videoSetting.vid));
                a = {ch: this.checkValue(c.getTypeFrom()), custid: this.checkValue(c.userInfo().userId)};
                this.model.videoSetting.hasOwnProperty("p") && (a.p = this.checkValue(this.model.videoSetting.p));
                for (var g = ["uu", "vu", "liveId", "streamId", "activityId"], l = 0; l < g.length; l++) c.config.hasOwnProperty(g[l]) && (a[g[l]] = c.config[g[l]]);
                ...
                switch (this.model.platform) {
                    ...
                    case "wx":
                        ...
                        break;
                    case "sdk":
                        ExternalInterface.callSDK(this.model.systemData.os, "logRequest", {url: a})
                }
            }, isMustHttps: function () {
                return "wx" == this.model.platform ||
                "sdk" == this.model.platform ? !0 : !1
            }
        };
        return b
        ...
        a.prototype.setUp = function (a, d) {
            if (this.model.config.hasOwnProperty("url")) {
                ...
                c.load()
            } else a.hasOwnProperty("uu") && a.hasOwnProperty("vu") && a.uu && a.vu ? (this.model.vodPlayType = GlobalHandler.checkPlayType(), this.vodproxy = "101" == this.model.videoSetting.p ? new CloudVodProxy(this.model) : new CloudMmsProxy(this.model),
                this.vodproxy.addEventListener(LoadEvent.LOADCMP, this.gpcCmp, this), this.vodproxy.addEventListener(LoadEvent.LOADERROR, this.errorHanlder, this), this.vodproxy.load()) : this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{code: ERR.PARAMS}]))
        };
        ...
        a.prototype.onPlaStopHandler = function () {
            this.emptyST && clearTimeout(this.emptyST);
            4 != this.playState && (this.playState =
                4, this.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.COMPLETE)))
        };
        ...
        a.prototype.onPlayIngHandler = function () {
            var a = this.getTime();
            if (0 <= a && !this.isFtc) if (0 <
                a) this.log("\u7b2c\u4e00\u6b21\u83b7\u5f97\u975e0\u7684\u64ad\u653e\u65f6\u95f4" + a), this.isFtc = !0, this.onPlayFullHandler(); else if ("iphone" == videoSdkTool.getDevice() && "qq" == videoSdkTool.getBrowser()) this.onPlayFullHandler();
        ...
        a.prototype.setUp = function (a, d) {
            ...
            this.videoBox = document.getElementById("v" +
                e);
            this.config = a;
            ...
            a.hasOwnProperty("x5Type") && "h5" == a.x5Type && /android/.test(videoSdkTool.getDevice()) &&
            (this.videoEL.setAttribute("x5-video-player-type", "h5"), a.hasOwnProperty("x5Fullscreen") && (a.x5Fullscreen ? this.videoEL.setAttribute("x5-video-player-fullscreen", "true") : this.videoEL.setAttribute("x5-video-player-fullscreen", "false")));
            for (e = 0; e < h.length; e++) a.hasOwnProperty(h[e]) && "width" != h[e] && "height" != h[e] && (this.videoEL[h[e]] = a[h[e]]);
            this.isShow = !0;
            this.vArea = this.videoBox;
            this.renderType = "";
            0 < this.outEl.offsetWidth & 0 < this.outEl.offsetHeight || (this.videoBox.style.width = "99.5%", this.videoBox.style.height =
                "99.5%");
        ...
        a.prototype.hide = function (a) {
            this.isShow && (a ? this.videoBox.style.display = "none" : (this.tmpwidth = this.videoBox.style.width, this.tmpheight = this.videoBox.style.height, this.videoBox.style.width = "1px",
                this.videoBox.style.height = "1px", this.videoBox.style.left = "-1000px", this.videoBox.style.top = "-1000px"), this.isShow = !1)
        };
        a.prototype.show = function () {
        ...
        a.prototype.setVideoRect = function () {
            if ("pano" ==
                ...
                this._videoRect = {
                    x: 0.5 * (this.outEl.offsetWidth -
                        a), y: 0.5 * (this.outEl.offsetHeight - b), width: a, height: b
                }
            }
        };
        a.prototype.addEvents = function () {
            for (var a = this.video, b = 0; b < d.length; b++) a.addEventListener(d[b], this.videoHandlerBack, !0)
        };
        a.prototype.removeEvents = function () {
            for (var a = this.video, b = 0; b < d.length; b++) a.removeEventListener(d[b], this.videoHandlerBack, !0)
        };
        ...
        a.prototype.getLoadPercent = function () {
            ...
            for (var a = this.video.buffered, b = 0; b < a.length; b++) if (this.getTime() < a.end(b)) return Math.min(1, a.end(b) / this.video.duration);
            return 0
        };
        a.prototype.play =
            function (a) {
        ...
        a.prototype.prePlay = function (a, b, d) {
            ...
            f.stream.init({
                video: f.videoEL, el: f.vArea, url: a, config: d, onstart: function () {
                    f.log("\u64ad\u653e\u5f15\u64ce\u521d\u59cb\u5316\u5b8c\u6bd5\uff0c\u56de\u8c03\u64ad\u653e, url:" + f.url);
                    f.video = f.stream.getVideo();
                    f.addEvents();
                    f.video.src = f.url;
                    if (f.autoplay || play) f.video.load && f.video.load(), f.resume(d.callback)
                }, onerror: function (h) {
                    "flv" == h.message ? (d.useFlv = !1, f.stream.close(),
                        f.prePlay(a, b, d)) : (f.log("\u64ad\u653e\u5f15\u64ce\u521d\u59cb\u5316\u5931\u8d25"), h.retryCdn = !1, f.errorHandler(h))
                }
            })
        };
        ...
        var b = {pano: {name: "PanoRender", check: videoSdkTool.checkPano, err: {code: "", message: ""}}};
        ...
        var b = {
            hls: {
                ...
                name: "media.mediaPlay.flv", check: function () {
                    return !0
                }, err: {code: "", message: ""}
            }
        };
        ...
        a.prototype.setUp = function (a, d) {
            var c = videoSdkTool.clone(this.config), g = ["pic", "volume"];
            this.loop = !1;
            this.el = d;
        ...
        a.prototype.startPlay = function (a) {
            var d = {start: 0, play: !1, type: "", callback: null}, c;
        ...
        a.prototype.closeVideo = function () {
            this.player.removeEventListener(MediaEvent.EVENT,
                this.MediaHanlder, this);
            this.player.stop()
        };
        a.prototype.getTime = function () {
    ...
    SOTool.shareObj("media.watermask", function () {
        ...
        a.prototype.setUp = function (a) {
            ...
            this._index = 0;
            var c = this;
            if (this.waterData) for (a = 0; a < this.waterData.length; a++) d =
                UiTool.$C("img"), d.num = a, this.waterData[a].hasOwnProperty("position") && this.waterData[a].hasOwnProperty("url") && (this.waterData[a].hasOwnProperty("x") || (this.waterData[a].x = 15), this.waterData[a].hasOwnProperty("y") || (this.waterData[a].y = 15), this.waterData[a].hasOwnProperty("width") || (this.waterData[a].width = 640), this.waterData[a].hasOwnProperty("height") || (this.waterData[a].height = 360), d.onload = function () {
        ...
        a.prototype.setSize =
            function (a, d) {
                for (var c = 0; c < this.waterList.length; c++) this._renderWater(this.waterList[c], this.waterData[c])
            };
        ...
        a.prototype._renderWater = function (a, d) {
            ...
            if (e.hasMetadata) {
                if (this.isPano()) var f = 1, h = 1; else f =
                ...
                switch (d.position + "") {
                    ...
                    case "3":
                        a.style.bottom =
                            0.5 * (this.el.offsetHeight - e.height) + h * g * d.y + "px";
                        a.style.left = e.x + f * g * d.x + "px";
                        break;
                    case "4":
                        a.style.bottom = 0.5 * (this.el.offsetHeight - e.height) + h * g * d.y + "px", a.style.right = 0.5 * (this.el.offsetWidth - e.width) + f * g * d.x + "px"
                }
                a.fScale = g;
                a.width = f * g * c.width;
    ...
    var PlayUrlProxy = function () {
            ...
            a.prototype.leUrlsHandler = function (a) {
                ...
                for (var d = 0; d < a.length; d++) a[d] = this.gslbLoader.checkGslbUrl(a[d]);
                return a
            };
            return a
            ...
            b.prototype.setUp = function (a, b) {
                ...
                g.player = a;
                g.videoOutEl = b;
                if (g.model.config.hasOwnProperty("onPlayerReady")) if ("function" != typeof g.model.config.onPlayerReady && (g.model.config.onPlayerReady = window[g.model.config.onPlayerReady]), "function" == typeof g.model.config.onPlayerReady) try {
                    var e = setTimeout(function () {
                        g.startLeAd.call(g)
                    }, 5E3);
                    g.model.config.onPlayerReady({video: g.player.player.video, el: this.videoOutEl}, function (a, b) {
                        switch (a) {
                            case "adstart":
                                clearTimeout(e);
                                break;
                    ...
                    g.startLeAd.call(g)
                } else g.startLeAd.call(g); else g.startLeAd.call(g)
            };
            b.prototype.startLeAd = function () {
                this.checkAd() ? this.model.videoSetting.hasOwnProperty("ark") ? "undefined" == typeof H5AD || "function" != typeof H5AD ? videoSdkTool.getJS(SOTool.PluginStack.Ad, this.initAd, this.initAd, this, "utf-8") : this.initAd() : this.model.videoSetting.hasOwnProperty("sspAd") && ("undefined" == typeof leH5AD || "function" != typeof leH5AD.initH5 ? videoSdkTool.getJS(SOTool.PluginStack.ssp,
                    this.initAd, this.initAd, this, "utf-8") : this.initAd()) : this.facade.dispatchEvent(new Event(AdEvent.EVENT, AdEvent.NOAD, "skip"))
            };
            b.prototype.checkAd = function () {
                return this.model.config.hasOwnProperty("letvad") && "0" == this.model.config.letvad.toString() || this.model.videoSetting.hasOwnProperty("needbuy") && "1" == this.model.videoSetting.needbuy.toString() || this.model.videoSetting.hasOwnProperty("ark") && "0" == this.model.videoSetting.ark.toString() || !this.model.videoSetting.hasOwnProperty("ark") && !this.model.videoSetting.hasOwnProperty("sspAd") ?
                    !1 : !0
            };
            b.prototype.initAd = function (b, c) {
                ...
                var e = this;
                if (e.model.videoSetting.hasOwnProperty("ark") && "undefined" != typeof H5AD && "function" == typeof H5AD) e.H5AD = new H5AD; else if ("undefined" != typeof leH5AD && "function" == typeof leH5AD.initH5) {
                ...
                "undefined" != typeof e.H5AD && "function" == typeof e.H5AD.initAD &&
                (f = new a, f.p1 = this.model.reportParam.p1, f.p2 = this.model.reportParam.p2, f.p3 = this.model.reportParam.p2, f.lc = this.model.lc(), f.uuid = this.model.uuid(), f.ver = this.model.playerConfig.version, f.gdur = this.model.videoSetting.duration, f.cont = this.videoOutEl.id, "vod" == this.model.playType ? (f.islive = !1, f.cid = this.model.videoSetting.cid, f.vid = this.model.videoSetting.vid, f.mmsid = this.model.videoSetting.mmsid, this.model.videoSetting.hasOwnProperty("pid") && (f.pid = this.model.videoSetting.pid)) : "live" == this.model.playType &&
                    (f.islive = !0, f.sid = this.model.config.activityId), f.ch = this.model.getTypeFrom(), f.ark = this.model.videoSetting.ark, f.useui = 1, this.model.videoSetting.hasOwnProperty("p") && (f.ext = "" == this.model.userData.userId ? this.model.videoSetting.p : this.model.videoSetting.p + "|" + this.model.userData.userId), 530 > this.videoOutEl.clientWidth && (f.pname = "MPlayer"), e.model.videoSetting.hasOwnProperty("sspAd") && (f.sspid = this.model.videoSetting.sspAd.sspId, f.slotid = this.model.videoSetting.sspAd.preSlotId, f.playid = this.model.uuid() +
                    "_" + videoSdkTool.now(), f.playInline = 1), e.H5AD.initAD(f, g))
            };
                ...
                function (a) {
                    switch (a.args[1]) {
                        ...
                        case MediaEvent.ERROR:
                            ...
                            }), this.curAdIndex++, this.H5AD.destory(this.curAd),
                                this.playAD()
                    }
                };
            ...
            b.prototype.destroy = function () {
                this.player && (!this.model.videoSetting.hasOwnProperty("ark") &&
                this.model.videoSetting.hasOwnProperty("sspAd") && this.sspPause(this.videoOutEl.skin.id), this.player.removeEventListener(MediaEvent.EVENT, this.mediaHandler, this), this.facade.removeEventListener(PlayerEvent.EVENT, this.playerHandler, this), this.player.closeVideo(), this.player = null);
                try {
            ...
            a.prototype.setStylebyConfig = function (a) {
                var b = ["controls", "fullscreen"], g = "vb" + videoSdkTool.creatUuid();
                this.el.className = g;
                for (var e = 0; e < b.length; e++) if (!a[b[e]]) if (a.pageControls) SkinRender["setMedia" + b[e]]("", !1); else SkinRender["setMedia" + b[e]](g, !1)
            };
            ...
            a.prototype.setDefinitionList = function () {
                ...
                for (g in b.videoSetting.media) a.push(g);
            ...
            a.prototype.play = function () {
                ...
                var g = a.mediaPlayer.player.videoEL.canPlayType && "" == a.mediaPlayer.player.videoEL.canPlayType("application/x-mpegURL"),
                    e = a.model.videoSetting.hasOwnProperty("playTypes") &&
                        a.model.videoSetting.playTypes.match(/3/) && "1" == a.model.videoSetting.playTypes.charAt(0);
                a.mediaPlayer.startPlay({
                    ...
                    callback: function () {
                        a.facade.dispatchEvent(new Event(PlayerEvent.EVENT,
                            PlayerEvent.GSLB_CMP))
                    }
                });
            ...
            a.prototype.setDefinition = function (a) {
                this.definition != a && -1 != this.model.videoSetting.definitionList.indexOf(a) && (this.log("\u5207\u6362\u7801\u6d41-----------------------------" + a), this.definition = a, this.isStartPlay = !1, a = 0, "vod" == this.model.playType &&
                (a = this.mediaPlayer.getTime()), this.playVideo(a), this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, MediaEvent.DEFSTART)))
            };
                ...
                switch (a.args[1]) {
                    ...
                    case MediaEvent.COMPLETE:
                        ...
                        if (this.model.config.hasOwnProperty("callbackJs")) {
                            var b = a.args[1], g = a.args[2];
                            WIN[this.model.config.callbackJs] && (a.args[2] = WIN[this.model.config.callbackJs](b,
                                g))
                        }
            ...
            a.prototype.addEvents = function () {
                ...
                UiTool.addEvent(document,
                    "fullscreenchange,webkitfullscreenchange,mozfullscreenchange,MSFullscreenChange", a.fullChangeFun);
                ...
                UiTool.addEvent(document, d + "visibilitychange", function () {
                    "hidden" == document[d + "VisibilityState"] ? a.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VPH)) : "visible" ==
                        document[d + "VisibilityState"] && a.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VPS))
                })
            };
            a.prototype.videoSateHandler = function (a) {
                switch (a.args[1]) {
            ...
            a.prototype.fullChange = function () {
                this.model.videoSetting && (this.model.videoSetting.fullscreen = UiTool.isFullScreen(), this.model.videoSetting.fullscreen || (this.cancelFullscreen(), this.resizeFun()),
            ...
            a.prototype.skinSateHandler = function (a) {
                switch (a.args[1]) {
                    case SkinEvent.FULLSCREEN:
                        ...
                        this.model.videoSetting.fullscreen ? (this.model.videoSetting.fullscreen = !1, this.cancelFullscreen(), UiTool.supportFullScreen() && this.model.config.dfull && UiTool.cancelFullScreen()) : (this.model.videoSetting.fullscreen = !0, this.player.skinplugin.skin.setAttribute({tmpStyle: this.player.skinplugin.el.style.cssText}),
                            UiTool.supportFullScreen() && this.model.config.dfull ? UiTool.fullScreen(this.player.skinplugin.el) : (this.bodyTmpOverFlow = document.body.style.overflow, document.body.style.overflow = "hidden"), this.player.skinplugin.skin.setStyle({cssText: "background: #000;width:100%;height:100%;position:fixed;top:0;left:0;z-index:1000;overflow:hidden;"}));
                        this.resizeFun()
                }
            };
            return a
            ...
            a.prototype.show = function (a) {
                ...
                d.error ? d.error.show(a, d.el, {
                    ...
                    c && (d.error = new c, d.error.show(a, d.el, {api: d._api, model: d.model}))
                })
            };
            ...
            return function (b) {
                for (var d = 0; d < ApiList.length; d++) a(ApiList[d], this, b)
            }
        }(), FlashSdk = function () {
            function a(a, d, c) {
                d[a] = function () {
            ...
            return function (b) {
                for (var d = 0; d < ApiList.length; d++) a(ApiList[d], this, b.plugin);
        ...
        H5Sdk = function () {
            ...
            a.prototype.removePoint = function (a) {
                this._pl.facade.dispatchEvent(new Event(SkinEvent.EVENT,
                    SkinEvent.DELPOINT, a))
            };
            ...
            a.prototype.getBufferPercent = function () {
                return this._pl.videoplugin ? this._pl.videoplugin.mediaPlayer.getBufferPercent() :
                    0
            };
            a.prototype.setDefinition = function (a) {
            ...
            a.prototype.getDefList = function () {
                for (var a = [], d = 0; d < this._pl.model.defaultDefinitionList.length; d++) {
                    var c =
                        GlobalHandler.type2Def(this._pl.model.defaultDefinitionList[d]);
                    a.push(c)
                }
                return a
            };
            ...
            configConver: function (a, b) {
                ...
                for (var g in a) {
                    if (d.hasOwnProperty(g)) {
                        for (var e =
                            0; e < d[g].length && g != d[g][e]; e++) ;
                        e == d[g].length && (a[g] = d[g][0])
                    }
                    b[g] = a[g]
                }
                for (g in c) a.hasOwnProperty(g) ? "boolean" == typeof c[g] && (a[g] = "1" == a[g]) : a[g] = c[g];
                    ...
                    case "iphone":
                        switch (videoSdkTool.getBrowser()) {
                            ...
                            default:
                                ...
                                c = [/cpu iphone os 8_/];
                                for (e = 0; e < c.length; e++) if (c[e].test(d)) {
                                    a.dvideoSize = !1;
                                    break
                                }
                                if (0 <= parseInt(a.posterType) && (c = [/cpu iphone os 6_/], a.skinnable)) for (e = 0; e < c.length; e++) if (c[e].test(d)) {
                                    a.onlyPic = !0;
                                    break
                                }
                        }
            ...
            a.prototype.setUp = function (a, d, c) {
                ...
                this.errorplugin.setUp(this,
                    this.skinplugin.el.error, this.api);
                this.addEvents();
            ...
            a.prototype.adHandler =
                function (a) {
                    ...
                    switch (a.args[1]) {
                        ...
                        case AdEvent.HEADEND:
                        case AdEvent.NOAD:
                            a.args[1] == AdEvent.HEADEND ? this.model.joint = 2 : this.model.joint = 0, this.facade.removeEventListener(AdEvent.EVENT, this.adHandler, this), this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, a.args[1], a.args[2])), this.creatVideo()
                    }
                };
            a.prototype.videoHandler = function (a) {
            ...
            a.prototype.nextHandler = function (a) {
                a.args[2] && a.args[2].hasOwnProperty("nextvid") && "" != a.args[2].nextvid && this.playNewId({vu: a.args[2].nextvid})
            };
            ...
            a.prototype.setPlayerInfo = function (a) {
                var d = {buttonColor: "fault", progressBarColor: "active"};
                if (a.hasOwnProperty("onoff")) {
                    for (var c in a.onoff) a[c] = a.onoff[c];
                    delete a.onoff
                }
                for (c in a) d.hasOwnProperty(c) && (a[d[c]] = a[c], delete a[c]), "boolean" == typeof this.model.config[c] && (a[c] = "1" == a[c] + "");
                d = {};
                d.logo = a.logo;
            ...
            a.prototype.setModelByEnv = function () {
                this.superClass.setModelByEnv.apply(this,
                    arguments);
            ...
            a.prototype = {
                setUp: function (a, d) {
                    ...
                    videoSdkTool.isHttps() && (c = "https://s.yuntv.letv.com/bclouds.swf");
                    a.hasOwnProperty("p") && 101 != a.p && (c = "http://yuntv.letv.com/player/vrp/vrp.swf");
                    a.hasOwnProperty("swf") && (c = a.swf);
                    a.hasOwnProperty("url") &&
                    (c = "http://yuntv.letv.com/player/live/direct/direct.swf");
                    DomainTool.getDomain(c);
                    a.hasOwnProperty("callback") && (a.callbackJs = a.callback, delete a.callback);
                    var g = "Opaque";
                    a.hasOwnProperty("wmode") && (g = a.wmode, delete a.wmode);
                    "Opaque" == g && (a.panoType = 1);
                    this.id = FlashPlayer.create(d, {url: c, version: this.minVer, wmode: g}, this.flashvarsToString(a));
        ...
        CloudPlayer = function () {
            ...
            a.prototype = {
                init: function (a) {
                    ...
                    return a.hasOwnProperty("type") ? a.type : a.hasOwnProperty("dbd") && "LETV" == a.dbd ? "h5" : "android" != videoSdkTool.getOs() && "iphone" != videoSdkTool.getDevice() && "ipad" != videoSdkTool.getDevice() && FlashPlayer.check(10) ? "swf" : document.createElement("video").canPlayType ?
                        "h5" : "swf"
                }
            };
            return a
            ...
            function a(a, b) {
                var d = "100%", f = "100%", h = "player" + videoSdkTool.creatUuid();
            ...
            d.prototype.init = function (c, d, e) {
                var f = a(c, d), h = b(c, f, d);
                this.sdk = new Api(h);
                if (e) {
                    var k = function (a) {
                        switch (a.args[1]) {
                            case PlayerEvent.INIT:
                                h.facade.removeEventListener(PlayerEvent.EVENT, k, this), c.hasOwnProperty("callback") && ("function" == typeof c.callback ? c.callback && c.callback(h.videoplugin.mediaPlayer.player.video) :
                                    c.callback && WIN[c.callback] && WIN[c.callback](h.videoplugin.mediaPlayer.player.video))
                        }
                    };
