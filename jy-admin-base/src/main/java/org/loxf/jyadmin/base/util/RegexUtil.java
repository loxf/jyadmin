...
public class RegexUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("判断中文字符: " + RegexUtil.isChineseChar("aaa中国！"));
